...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOH, VCC_OUT1_Pin|VCC_OUT2_Pin|VCC_OUT3_Pin|VCC_OUT4_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : VCC_OUT1_Pin VCC_OUT2_Pin VCC_OUT3_Pin VCC_OUT4_Pin */
